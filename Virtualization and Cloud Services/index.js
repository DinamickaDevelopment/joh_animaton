...
tl.staggerTo([RightSnake,MiddleSnake,LeftSnake],0.33, {strokeDashoffset:'-36px'})
  ...
  .to(Horizontal2,0.48,{delay:0.45,strokeDashoffset:'0'},'LineApear')
  .to(VerticalLine,0.99,{strokeDashoffset:'0'},'LineApear')
  .staggerTo([RightSnake,MiddleSnake,LeftSnake],0.99, {strokeDashoffset:'-72px'})
